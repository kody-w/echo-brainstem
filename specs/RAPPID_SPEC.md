...
> **Frozen excerpt** of the canonical rappid contract (`rapp-rappid/2.0`). Bundled at planting time on 2026-05-09T15:23:14Z.
...
```
rappid:v2:<kind>:@kody-w/echo-brainstem:<32-hex>@github.com/kody-w/echo-brainstem
```
